        ...
        lazyLoad: function() {
            ...
            if (lazyLoadEl.length > 0) {
                lazyLoadEl.each(function() {
                    ...
                    element.attr('src', '/assets/frontend/images/blank.svg').css({
                        'background': 'url(/assets/frontend/images/preloader.gif) no-repeat center center #FFF'
                    });
        ...
        topsearch: function() {
            ...
            $(document).on('click', function(event) {
                ...
                if (!$(event.target).closest('#primary-menu').length) {
                    $('#primary-menu.on-click > ul').find('.show').removeClass('show');
                }
        ...
        tabsResponsive: function() {
            ...
            $tabsResponsive.each(function() {
                ...
                elementNav.children('li').each(function() {
                    ...
                    elementContent.find(navElTarget).before('<div class="acctitle hide"><i class="acc-closed fa fa-ok-circle"></i><i class="acc-open fa fa-remove-circle"></i>' + navElContent + '</div>');
                });
            });
        },
                ...
                element.find('form').validate({
                    submitHandler: function(form) {
                        ...
                        if (elementLoader == 'button') {
                            ...
                            defButton.html('<i class="fa fa-line-loader fa fa-spin nomargin"></i>');
                        } else {
                ...
                element.find('form').validate({
                    submitHandler: function(form) {
                        ...
                        if (elementLoader == 'button') {
                            ...
                            $(form).find('.input-group-addon').find('.fa fa-email2').removeClass('fa fa-email2').addClass('fa fa-line-loader fa fa-spin');
                        }
                        ...
                        $(form).ajaxSubmit({
                            ...
                            success: function(data) {
                                if (elementLoader == 'button') {
                                    ...
                                    $(form).find('.input-group-addon').find('.fa fa-line-loader').removeClass('fa fa-line-loader fa fa-spin').addClass('fa fa-email2');
                                }
                                if (data.alert != 'error' && elementRedirect) {
                                    window.location.replace(elementRedirect);
                                    return true;
