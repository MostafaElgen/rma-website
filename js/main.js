!(function(e) {
    ...
    t.length && t.datetimepicker({
        ...
        e(window).on("scroll", function() {
            n(),
                e(window).scrollTop() > 150 ? e("#header_1").addClass("menu-sticky") : e("#header_1").removeClass("menu-sticky"),
                e(window).scrollTop() > 175 ? e("#header_2").addClass("menu-sticky") : e("#header_2").removeClass("menu-sticky"),
                e(window).scrollTop() > 95 ? e("#header_3").addClass("menu-sticky") : e("#header_3").removeClass("menu-sticky"),
                e(window).scrollTop() > 700 ? e(".scrollUp").addClass("back-top") : e(".scrollUp").removeClass("back-top");
        }),
    ...
    e(".multi-side-hover").each(function() {
        ...
        /*
                e("nav#dropdown").meanmenu({ siteLogo: "<div class='mobile-menu-nav-back'><a class='logo-mobile' href='index.html'><img src='images/logo.png' alt='logo' class='img-fluid'/></a></div>" }),*/

        e(".ex1").length && e(".ex1").zoom(),
        void 0 !== e.fn.knob &&
        e(".knob.knob-nopercent").each(function() {
            var a = e(this),
                t = a.attr("data-rel");
            a.knob({
                    draw: function() {}
    ...
    if (
        (c.length &&
            c.validator().on("submit", function(a) {
                var t = e(this),
            ...
            /*e(".parallaxie").length && e(".parallaxie").parallaxie({ speed: 0.5, offset: 0 }),*/
            e("#googleMap").length)
    ) {
    ...
    e(".rc-carousel").each(function() {
        ...
        e(window).on("load", function() {
            var a;
            (a = e("#slick-carousel-wrap")).length &&
                (a
                ...
                (a = e("#slick-carousel-wrap2")).length &&
                (a
                    .find(".carousel-content")
                    .slick({
                        slidesToShow: 1,
            ...
            var t = e("#countdown");
            t.length &&
                t.countdown("2019/08/21", function(a) {
                    e(this).html(
                        a.strftime(
            ...
            if (
                (s.length > 0 &&
                    s.find(".isotope-classes-tab").on("click", "a", function() {
                        var a = e(this);
        ...
        e(window).on("load resize", function() {
            ...
            e(".mean-nav > ul"),
                ...
                (n = 0),
                (i = e(window).width()),
                e(".equal-height-wrap .item-img,.equal-height-wrap .item-content").height("auto"),
                i > 991 &&
                (e(".equal-height-wrap").each(function() {
                        var a = e(this),
                    ...
                    (a = t),
                    (a = n > t ? n : t),
                    e(".equal-height-wrap .item-img,.equal-height-wrap .item-content").height(a + "px"));
        }),
        e(window).on("scroll", function() {
            var a = e("#sticker"),
                t = e("body"),
            ...
            if (i > 991) {
                t.css("padding-top", "");
                var d;
                s.length ? ((d = n = 1), 0) : r.length && o <= (d = l.outerHeight()) && r.hasClass("header-fixed") && r.css("top", "-" + o + "px"),
                    o >= d ?
                    ((r.length || s.length) && a.addClass("stick"), r.length && (r.hasClass("header-fixed") ? r.css("top", "-" + d + "px") : t.css("padding-top", n + "px"))) :
                    (a.removeClass("stick"), r.length && t.css("padding-top", 0));
            }
        });
})(jQuery);
...
$('.nav-control-layout4').owlCarousel({
    loop: true,
    margin: 10,
    dots: false,
    nav: true,
...
$(".menu-toggler").click(function() {
    $(".device-xxs").toggleClass("off-scroll");
});
